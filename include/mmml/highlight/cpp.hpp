...
#define MMML_CPP_TOKEN_ENUM_DATA(F)                                                                \
    F(exclamation, "!", symbol, 1)                                                                 \
    F(exclamation_eq, "!=", symbol, 1)                                                             \
    F(pound, "#", meta, 1)                                                                         \
    F(pound_pound, "##", meta, 1)                                                                  \
    F(percent, "%", symbol, 1)                                                                     \
    F(pound_alt, "%:", meta, 1)                                                                    \
    F(pound_pound_alt, "%:%:", meta, 1)                                                            \
    F(percent_eq, "%=", symbol, 1)                                                                 \
    F(right_brace_alt, "%>", symbol_important, 1)                                                  \
    F(amp, "&", symbol, 1)                                                                         \
    F(amp_amp, "&&", symbol, 1)                                                                    \
    F(amp_eq, "&=", symbol, 1)                                                                     \
    F(left_parens, "(", symbol_important, 1)                                                       \
    F(right_parens, ")", symbol_important, 1)                                                      \
    F(asterisk, "*", symbol, 1)                                                                    \
    F(asterisk_eq, "*=", symbol, 1)                                                                \
    F(plus, "+", symbol, 1)                                                                        \
    F(plus_plus, "++", symbol, 1)                                                                  \
    F(plus_eq, "+=", symbol, 1)                                                                    \
    F(comma, ",", symbol_other, 1)                                                                 \
    F(minus, "-", symbol, 1)                                                                       \
    F(minus_minus, "--", symbol, 1)                                                                \
    F(minus_eq, "-=", symbol, 1)                                                                   \
    F(arrow, "->", symbol, 1)                                                                      \
    F(member_arrow_access, "->*", symbol, 1)                                                       \
    F(dot, ".", symbol, 1)                                                                         \
    F(member_pointer_access, ".*", symbol, 1)                                                      \
    F(ellipsis, "...", symbol, 1)                                                                  \
    F(slash, "/", symbol, 1)                                                                       \
    F(slash_eq, "/=", symbol, 1)                                                                   \
    F(colon, ":", symbol_other, 1)                                                                 \
    F(scope, "::", symbol, 1)                                                                      \
    F(right_square_alt, ":>", symbol_important, 1)                                                 \
    F(semicolon, ";", symbol_other, 1)                                                             \
    F(less, "<", symbol, 1)                                                                        \
    F(left_brace_alt, "<%", symbol_important, 1)                                                   \
    F(left_square_alt, "<:", symbol_important, 1)                                                  \
    F(less_less, "<<", symbol, 1)                                                                  \
    F(less_less_eq, "<<=", symbol, 1)                                                              \
    F(less_eq, "<=", symbol, 1)                                                                    \
    F(three_way, "<=>", symbol, 1)                                                                 \
    F(eq, "=", symbol, 1)                                                                          \
    F(eq_eq, "==", symbol, 1)                                                                      \
    F(greater, ">", symbol, 1)                                                                     \
    F(greater_eq, ">=", symbol, 1)                                                                 \
    F(greater_greater, ">>", symbol, 1)                                                            \
    F(greater_greater_eq, ">>=", symbol, 1)                                                        \
    F(question, "?", symbol, 1)                                                                    \
    F(left_square, "[", symbol_important, 1)                                                       \
    F(right_square, "]", symbol_important, 1)                                                      \
    F(caret, "^", symbol, 1)                                                                       \
    F(caret_eq, "^=", symbol, 1)                                                                   \
    F(caret_caret, "^^", symbol, 1)                                                                \
    ...
    F(left_brace, "{", symbol_important, 1)                                                        \
    F(pipe, "|", symbol, 1)                                                                        \
    F(pipe_eq, "|=", symbol, 1)                                                                    \
    F(pipe_pipe, "||", symbol, 1)                                                                  \
    F(right_brace, "}", symbol_important, 1)                                                       \
    F(tilde, "~", symbol, 1)

#define MMML_CPP_TOKEN_ENUM_ENUMERATOR(id, code, highlight, strict) id,
