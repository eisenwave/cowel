...
static_assert(offsetof(cowel_options, highlight_theme_source)
...
static_assert(offsetof(cowel_options, min_log_severity)
              == offsetof(cowel_options_u8, min_log_severity));
static_assert(offsetof(cowel_options, preserved_variables)
              == offsetof(cowel_options_u8, preserved_variables));
static_assert(offsetof(cowel_options, preserved_variables_size)
              == offsetof(cowel_options_u8, preserved_variables_size));
static_assert(offsetof(cowel_options, consume_variables)
              == offsetof(cowel_options_u8, consume_variables));
static_assert(offsetof(cowel_options, consume_variables_data)
...
static_assert(offsetof(cowel_options, load_file_data)
              == offsetof(cowel_options_u8, load_file_data));
...
static_assert(offsetof(cowel_options, highlight_policy)
              == offsetof(cowel_options_u8, highlight_policy));
...
static_assert(offsetof(cowel_gen_result, hovers_size)
              == offsetof(cowel_gen_result_u8, hovers_size));
