...
- Added `cowel_str_at` directive for accessing a code point by index (#NNN)
...
- Added a rudimentary language server that processes every open COWEL document
    - Added "error squiggles" for errors during processing. (#342)
    - Added information about the code point and its name when hovering over escapes (#365)
