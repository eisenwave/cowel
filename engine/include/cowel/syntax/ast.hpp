...
public:
    ...
    {
        // For a directive-splice,
        // the source includes a leading backslash that is not part of m_name.
        // Include it in the name span so that the span covers the full directive-splice token.
